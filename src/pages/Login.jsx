...
export default function Login() {
  ...
  const cardStyle = { background: '#fff', padding: '2rem', borderRadius: '8px', width: '320px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }
  const inputStyle = { width: '100%', padding: '0.5rem', marginBottom: '1rem', border: '1px solid #ddd', borderRadius: '4px' }
  const labelStyle = { display: 'block', marginBottom: '0.25rem', fontSize: '0.875rem' }
  const btnStyle = { width: '100%', padding: '0.625rem', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer', marginBottom: '0.75rem' }
  const linkStyle = { background: 'none', border: 'none', color: '#2563eb', cursor: 'pointer', fontSize: '0.875rem', textDecoration: 'underline', padding: 0 }
